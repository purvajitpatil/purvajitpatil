...
I'm a third-year **Information Technology** student at Bharti Vidyapeeth College of Engineering, primarily building with **Python** — from AI/ML pipelines and RAG systems to backend services — and I like understanding systems from the ground up rather than just calling an API.

That's why instead of just calling a vector database API, I built one. And why instead of using a firewall SDK, I wrote a deep packet inspection engine that parses TLS handshakes byte-by-byte to extract SNI.

- 🔭 **Currently building:** ML tooling + AI pipelines in Python (VectorDB + RAG pipelines)
- 🌱 **Currently exploring:** ML infrastructure, distributed systems, applied AI engineering
- 🎯 **Looking for:** Student Researcher / SWE internships in ML Infra, Backend Engineering, or AI/Software
- ⚡ **Fun fact:** Built a full RAG pipeline and AI tooling stack in Python — on top of a from-scratch vector database engine supporting HNSW, KD-Tree, and brute-force search
...
**Languages**
<br/>
<img src="https://skillicons.dev/icons?i=py,js,ts,cpp,c" />
